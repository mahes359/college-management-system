...
public class RemoteSoapService {
    ...
    private static final String STUDENT_SERVICE =
            "STUDENT-SERVICE";

    private static final String COURSE_SERVICE =
            "COURSE-SERVICE";
    ...
    public void validateStudentExists(Long studentId) {
        ...
        ServiceInstance instance =
                chooseInstance(STUDENT_SERVICE);
        ...
        /*
         * IMPORTANT:
         * Do NOT create a SOAP Envelope here.
         *
         * WebServiceTemplate creates the SOAP envelope.
         * We only provide the SOAP payload.
         */
        String request =
                """
                <stu:getStudentRequest
                    xmlns:stu="http://college.com/student">
        ...
        try {
            ...
            throw new StudentServiceException(
                    "Unable to communicate with Student Service",
                    exception
            );
        }
    }
    ...
    public void validateCourseExists(Long courseId) {
        ...
        String request =
                ...
                <cou:getCourseRequest
                    xmlns:cou="http://college.com/course">
        ...
        try {
            ...
            throw new CourseServiceException(
                    "Unable to communicate with Course Service",
                    exception
            );
        }
    }
